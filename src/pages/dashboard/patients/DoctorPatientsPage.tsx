    ...
    <div className="p-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
        <div>
          ...
          <p className="text-gray-600">Manage your assigned patients and their medical records</p>
        </div>
          ...
          <div key={patient._id} className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-2 mb-4">
              ...
              {patient.latestAppointmentReason && (
                <p className="text-sm text-gray-600">
                  <strong>Latest Visit Reason:</strong> {patient.latestAppointmentReason}
                </p>
              )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-lg shadow-lg w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="px-6 py-4">
              {/* Basic Information */}
              <div className="mb-6">
                <h3 className="text-md font-semibold text-gray-900 mb-3">Patient Information</h3>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  {selectedPatient.totalAppointments && (
                    <div>
                      ...
                      <p className="text-sm text-gray-900">{selectedPatient.totalAppointments}</p>
                    </div>
                  )}
                  {selectedPatient.latestAppointmentDate && (
                    <div>
                      ...
                      <p className="text-sm text-gray-900">
                        {new Date(selectedPatient.latestAppointmentDate).toLocaleDateString()}
                      </p>
                    </div>
                  )}
                </div>
              ...
              {/* Appointment Reasons */}
              {selectedPatient.appointmentReasons && selectedPatient.appointmentReasons.length > 0 && (
                <div className="mb-6">
                  <h3 className="text-md font-semibold text-gray-900 mb-3">Visit Reasons</h3>
                  <div className="space-y-2">
                    {selectedPatient.appointmentReasons.map((reason, index) => (
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-md font-semibold text-gray-900">Medical History</h3>
                  <button
                    onClick={() => {
            ...
            <div className="px-6 py-4 space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setRecordData(prev => ({ ...prev, disease: e.target.value }))}
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setRecordData(prev => ({ ...prev, treatment: e.target.value }))}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  rows={3}
